...
func main() {
	...
	instrConfig := fmt.Sprintf(`{
		...
		"options": { "plugins": { "title": { "display": true, "text": "Dynamic Instructions vs Iterations" } }, "scales": { "x": { "type": "logarithmic", "position": "bottom", "title": { "display": true, "text": "Iteration Value" } }, "x2": { "type": "category", "position": "top", "title": { "display": true, "text": "UxHw Trials" }, "grid": { "drawOnChartArea": false } }, "y": { "type": "linear", "stack": "y-axes", "stackWeight": 1, "position": "left", "beginAtZero": true, "grace": "10%%", "title": { "display": true, "text": "Monte Carlo" } }, "y2": { "type": "linear", "stack": "y-axes", "stackWeight": 1, "position": "left", "beginAtZero": true, "grace": "10%%", "title": { "display": true, "text": "Signaloid API" } } } }
	...
	timeConfig := fmt.Sprintf(`{
		...
		"options": { "plugins": { "title": { "display": true, "text": "Processor Time vs Iterations" } }, "scales": { "x": { "type": "logarithmic", "position": "bottom", "title": { "display": true, "text": "Iteration Value" } }, "x2": { "type": "category", "position": "top", "title": { "display": true, "text": "UxHw Trials" }, "grid": { "drawOnChartArea": false } }, "y": { "type": "linear", "stack": "y-axes", "stackWeight": 1, "position": "left", "beginAtZero": true, "grace": "10%%", "title": { "display": true, "text": "Monte Carlo (s)" } }, "y2": { "type": "linear", "stack": "y-axes", "stackWeight": 1, "position": "left", "beginAtZero": true, "grace": "10%%", "title": { "display": true, "text": "Signaloid API (s)" } } } }
	...
	execTimeConfig := fmt.Sprintf(`{
		...
		"options": { "plugins": { "title": { "display": true, "text": "Execution Time vs Iterations" } }, "scales": { "x": { "type": "logarithmic", "position": "bottom", "title": { "display": true, "text": "Iteration Value" } }, "x2": { "type": "category", "position": "top", "title": { "display": true, "text": "UxHw Trials" }, "grid": { "drawOnChartArea": false } }, "y": { "type": "linear", "stack": "y-axes", "stackWeight": 1, "position": "left", "beginAtZero": true, "grace": "10%%", "title": { "display": true, "text": "Monte Carlo (ms)" } }, "y2": { "type": "linear", "stack": "y-axes", "stackWeight": 1, "position": "left", "beginAtZero": true, "grace": "10%%", "title": { "display": true, "text": "Signaloid API (ms)" } } } }
